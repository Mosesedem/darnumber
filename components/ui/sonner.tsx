    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          success: "bg-background text-foreground border-green-500",
          error: "bg-background text-foreground border-red-500",
          warning: "bg-background text-foreground border-yellow-500",
          info: "bg-background text-foreground border-blue-500",
        },
      }}
      icons={{
        success: (
